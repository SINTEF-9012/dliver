...
public class SimpleDliverTest implements DliverListener {
    ...
    public static Dliver connectDliver() {
    	try {
    ...
    public static void main(String[] args) {
    	Dliver e = connectDliver();
    	e.addDliverListener(new SimpleDliverTest());
    	if(e != null) {
    		//e.setBTUpdateInterval(1);
    		//e.setHRAverageInterval(1);
    		//e.setHRUpdateInterval(1);
    		//e.setTempAverageInterval(1);
    		e.setDataMode(DliverMode.RawGyroMode);
